...
def main(cfg):
    ...
    # with open('/home/SamruddhiPai/Desktop/dd3d/configs/dd3d_config.yaml','w') as f:
    #     yaml.dump(cfg_json,f)
    
    # print('After Hydra, in main!!!!!!!!!!!!!')
    # print(cfg)
    # sys.exit()
    setup(cfg)
...
def do_train(cfg, model):
    ...
    max_iter = 5000 # cfg.SOLVER.MAX_ITER
    ...
    for data, iteration in zip(dataloader, range(max_iter * accumulate_grad_batches)):
        # print('iteration,max_iter,accumulate_grad_batches',iteration, max_iter ,accumulate_grad_batches)
        iteration += 1
...
def do_test(cfg, model, is_last=False, use_tta=False):
    # print('In Test!!!!!!!!! Viz Predictions', cfg.VIS.PREDICTIONS_ENABLED)
        ...
        if cfg.VIS.PREDICTIONS_ENABLED and d2_comm.is_main_process():
            ...
            for viz_name in visualizer_names:
                ...
                for x in tqdm(sampled_dataset_dicts):
                    try:
                        ...
                        print('Missed visualization!!!',e)

            print('Destination output directory',dset_output_dir)
            # print('Vis image dictionary!!!!!!!!!',viz_images.keys())
            ...
            if cfg.WANDB.ENABLED:
                ...
                for sample_id in viz_images.keys():
                    # print('len of values in viz image',len(list(viz_images[sample_id].values())))
