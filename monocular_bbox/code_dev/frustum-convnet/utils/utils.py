...
sys.path.append('/home/SamruddhiPai/Desktop/monocular_3d_boundingBox/code_dev/frustum-convnet/models/')
...
def import_from_file(def_file, cover=True):
    # if def_file == 'models/det_base.py':
    #     def_file = '/home/SamruddhiPai/Desktop/monocular_3d_boundingBox/code_dev/frustum-convnet/models/det_base.py'
    def_file = os.path.join('/home/SamruddhiPai/Desktop/monocular_3d_boundingBox/code_dev/frustum-convnet',def_file)
